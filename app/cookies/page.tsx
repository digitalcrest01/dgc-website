  ...
  return (
    <section className="container-page max-w-3xl pt-14 lg:pt-20">
      ...
      <div className="mt-8 space-y-5 text-sm leading-relaxed text-navy/80">
        ...
        <h2 className="font-display text-lg font-semibold tracking-tight text-navy">Categories</h2>
        ...
        <div className="overflow-hidden rounded-xl border border-navy/10">
          <table className="w-full border-collapse text-left text-[13px]">
            <thead className="bg-cream-100/60 font-mono text-[10px] uppercase tracking-[0.18em] text-navy/55">
              <tr>
            ...
            <tbody>
              {rows.map((r) => (
                <tr key={r.name} className="border-t border-navy/10 align-top">
                  <td className="px-3 py-2 font-mono text-[12px] text-navy">{r.name}</td>
                  <td className="px-3 py-2 text-navy/75">{r.purpose}</td>
                  <td className="px-3 py-2 text-navy/75">{r.lifetime}</td>
                  <td className="px-3 py-2 text-navy/75">{r.category}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <h2 className="font-display text-lg font-semibold tracking-tight text-navy">Questions</h2>
        <p>
          Email{' '}
